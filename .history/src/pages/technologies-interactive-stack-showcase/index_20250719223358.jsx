...
const TechnologiesInteractiveStackShowcase = () => {
  ...
  // Updated technologies with accurate information
  const technologies = {
    frontend: [
      {
        id: 1,
  ...
  const currentTechnologies = technologies[activeCategory] || [];
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="pt-24 pb-16 px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Technology Stats - slightly less to the right with padding-right */}
            <div className={`flex justify-end pr-16 transition-all duration-1000 delay-200 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}>
