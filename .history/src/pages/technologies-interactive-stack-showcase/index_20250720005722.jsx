      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="pt-24 pb-16 px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Technology Stats - CENTERED */}
            <div className={`flex justify-center transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className={`transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <div className="relative min-h-[600px]">
                {categories.map((category) => (
                  <div
                    key={category.id}
                    className={`absolute inset-0 transition-all duration-500 ${activeCategory === category.id ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8 pointer-events-none'}`}
                  >
                    <CategoryCarousel
                      category={category}
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-card rounded-xl p-8 border border-border">
                  ...
                  <div className="space-y-6">
                    {/* Sections omitted for brevity, still intact */}
                  </div>
                </div>
              </div>
            </div>
