  ...
  const socialLinks = [
    {
      name: 'GitHub',
      icon: 'Github',
      url: 'https://github.com/anamaya',
      color: 'text-gray-700 hover:text-gray-900'
    },
    {
      name: 'LinkedIn',
      icon: 'Linkedin',
      url: 'https://linkedin.com/in/anamaya',
      color: 'text-blue-600 hover:text-blue-700'
    },
    {
      name: 'Twitter',
      icon: 'Twitter',
      url: 'https://twitter.com/anamaya_dev',
      color: 'text-blue-400 hover:text-blue-500'
    },
    {
      name: 'Portfolio',
      icon: 'Globe',
      url: 'https://anamaya.dev',
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Button
              ...
              iconName="Phone"
              iconPosition="left"
              onClick={() => window.location.href = 'tel:+212-XXX-XXXX'}
            >
              Schedule Call
            </Button>
            <Button
